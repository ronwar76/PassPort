...
class PasswordsController extends Controller
{
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Passwords']))
			$model->attributes=$_GET['Passwords'];
	...
	{
		$model=Passwords::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Passwords $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='passwords-form')
		{
